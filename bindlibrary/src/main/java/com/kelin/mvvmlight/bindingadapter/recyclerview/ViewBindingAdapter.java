...
public class ViewBindingAdapter {
    ...
    @BindingAdapter({"adoucuent"})
    public static void setLayoutManagers(RecyclerView recyclerView, int adoucuent){
        Log.d("tom_i","=======");
        //System.out.println("========="+LayoutManagers.toString());

        //recyclerView.setLayoutManager(LayoutManagers.create(recyclerView));
    }
